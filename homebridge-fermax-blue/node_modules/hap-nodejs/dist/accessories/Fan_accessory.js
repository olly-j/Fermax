...
const fan = exports.accessory = new __1.Accessory("Fan", __1.uuid.generate("hap-nodejs:accessories:Fan"));
...
fan.on("identify" /* AccessoryEventTypes.IDENTIFY */, (paired, callback) => {
    FAKE_FAN.identify();
    callback(); // success
});
